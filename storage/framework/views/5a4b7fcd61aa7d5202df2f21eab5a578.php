...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'AnimasiGlobal'); ?> — AnimasiGlobal</title>
...
<nav class="navbar navbar-expand-lg">
    <div class="container">
        <a class="navbar-brand" href="<?php echo e(route('animations.index')); ?>">🎬 Animasi<span>Global</span></a>
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navMenu">
            <span class="navbar-toggler-icon"></span>
        </button>
        <div class="collapse navbar-collapse" id="navMenu">
            <ul class="navbar-nav me-auto ms-3 gap-1">
                <li class="nav-item"><a class="nav-link <?php echo e(request()->routeIs('animations.index') ? 'active':''); ?>" href="<?php echo e(route('animations.index')); ?>"><i class="bi bi-house-fill me-1"></i>Beranda</a></li>
                <li class="nav-item"><a class="nav-link <?php echo e(request()->routeIs('animations.boxoffice') ? 'active':''); ?>" href="<?php echo e(route('animations.boxoffice')); ?>"><i class="bi bi-trophy-fill me-1"></i>Box Office</a></li>
                <li class="nav-item"><a class="nav-link <?php echo e(request()->routeIs('animations.recommended') ? 'active':''); ?>" href="<?php echo e(route('animations.recommended')); ?>"><i class="bi bi-star-fill me-1"></i>Rekomendasi</a></li>
                <li class="nav-item"><a class="nav-link <?php echo e(request()->routeIs('countries.index') ? 'active':''); ?>" href="<?php echo e(route('countries.index')); ?>"><i class="bi bi-globe2 me-1"></i>Negara</a></li>
            </ul>
            <a href="<?php echo e(route('animations.create')); ?>" class="nav-link btn-nav-add"><i class="bi bi-plus-lg me-1"></i>Tambah Film</a>
        </div>
    </div>
</nav>
...
<footer>
    <div class="container d-flex justify-content-between align-items-center flex-wrap gap-2">
        ...
        <small class="d-flex gap-3">
            <a href="<?php echo e(route('animations.index')); ?>" class="text-decoration-none" style="color:var(--muted)">Beranda</a>
            <a href="<?php echo e(route('animations.create')); ?>" class="text-decoration-none" style="color:var(--muted)">Tambah Film</a>
            <a href="<?php echo e(route('countries.index')); ?>" class="text-decoration-none" style="color:var(--muted)">Negara</a>
        </small>
    </div>
</footer>
...
<?php /**PATH C:\Users\Hp Victus\Downloads\animasi-global\resources\views/animations/layout.blade.php ENDPATH**/ ?>