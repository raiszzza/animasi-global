<?php $__env->startSection('title', 'Tambah Film'); ?>
...
<div class="row justify-content-center">
    <div class="col-lg-8">
        <div style="background:var(--card); border:1px solid var(--border); border-radius:18px; padding:32px 36px;">
            ...
            <form action="<?php echo e(route('animations.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="row g-4">
                    <div class="col-12">
...
unset($__errorArgs, $__bag); ?>"
                               value="<?php echo e(old('title')); ?>" placeholder="Contoh: Spirited Away">
...
unset($__errorArgs, $__bag); ?>"
                               value="<?php echo e(old('genre')); ?>" placeholder="Contoh: Fantasi, Petualangan">
...
unset($__errorArgs, $__bag); ?>"
                               value="<?php echo e(old('year', date('Y'))); ?>" min="1900" max="2099">
...
unset($__errorArgs, $__bag); ?>"
                               value="<?php echo e(old('rating')); ?>" placeholder="7.5">
...
unset($__errorArgs, $__bag); ?>"
                               value="<?php echo e(old('box_office')); ?>" placeholder="Opsional">
...
unset($__errorArgs, $__bag); ?>"
                                  placeholder="Ceritakan sinopsis singkat film ini..."><?php echo e(old('synopsis')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                               value="<?php echo e(old('poster_url')); ?>" placeholder="https://image.tmdb.org/...">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-12">
                        <div class="form-check d-flex align-items-center gap-2" style="padding:12px 16px; background:var(--surface); border-radius:10px; border:1px solid var(--border)">
                            <input class="form-check-input" type="checkbox" name="is_recommended" id="rec" value="1"
                                   <?php echo e(old('is_recommended') ? 'checked':''); ?> style="width:18px; height:18px;">
                    ...
                    <div class="col-12 d-flex gap-3 pt-2">
                        ...
                        <a href="<?php echo e(route('animations.index')); ?>" class="btn btn-ghost px-4 py-2">Batal</a>
                    </div>
                </div>
            </form>
        </div>
...
<?php echo $__env->make('animations.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Hp Victus\Downloads\animasi-global\resources\views/animations/create.blade.php ENDPATH**/ ?>